...
This project aims to guide you through the process of creating internationalized web pages using Flask and Babel. By completing a series of tasks, you will learn how to implement localization and handle multiple languages in a web application.
...
Internationalization (i18n) is the process of adapting software to different languages and regional differences. This project will help you understand and implement i18n in a Flask web application using the Flask-Babel extension.

## Project Structure

The project is organized into different tasks, each of which builds on the previous one. You will be working with Flask, Jinja templates, and Flask-Babel to create a multi-language web application.

## Tasks To Complete

### Task 0: Basic Flask app
- [x] Create a basic Flask app with a single route (`/`) and an index template ([0-index.html](templates/0-index.html)).
- The index template should display "Welcome to Holberton" as the page title and "Hello world" as the header.

### Task 1: Basic Babel setup
- [x] Copy [0-app.py](0-app.py) into [1-app.py](1-app.py) and [templates/0-index.html](templates/0-index.html) into [templates/1-index.html](templates/1-index.html).
- Install the Babel Flask extension by running the command: `pip3 install flask_babel`.
- Instantiate the `Babel` object in your app and store it in a module-level variable named `babel`.
- Create a `Config` class with a `LANGUAGES` class attribute set to `["en", "fr"]`.
- Use the `Config` class to set Babel's default locale to `"en"` and timezone to `"UTC"`.

### Task 2: Get locale from request
- [x] Copy [1-app.py](1-app.py) into [2-app.py](2-app.py) and [templates/1-index.html](templates/1-index.html) into [templates/2-index.html](templates/2-index.html).
- Implement a `get_locale` function with the `babel.localeselector` decorator.
- Use `request.accept_languages` to determine the best-matched supported language.

### Task 3: Parametrize templates
- [x] Copy [2-app.py](2-app.py) into [3-app.py](3-app.py) and [templates/2-index.html](templates/2-index.html) into [templates/3-index.html](templates/3-index.html).
- Parametrize templates using the `_` or `gettext` function with message IDs `home_title` and `home_header`.
